    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
          ...
          <br />
          阿里云服务器折扣区
          <el-link href="http://aly.auths.vip" type="primary" target="_blank"
            >>☛☛点我进入☚☚</el-link
          >
          &nbsp;&nbsp;&nbsp; 腾讯云服务器秒杀区
          <el-link href="http://txy.auths.vip" type="primary" target="_blank"
            >>☛☛点我进入☚☚</el-link
          ><br />
      ...
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        ...
        <p>
          <el-button
            ...
            icon="Cloudy"
            plain
            @click="goTarget('https://gitee.com/y_project/Auths-Cloud')"
            >访问码云</el-button
          >
          <el-button
            icon="HomeFilled"
            plain
            @click="goTarget('http://auths.vip')"
            >访问主页</el-button
          >
        </p>
      </el-col>
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 官网：<el-link
                href="http://www.auths.vip"
                target="_blank"
                >http://www.auths.vip</el-link
              >
            </p>
            <p>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <el-collapse accordion>
            <el-collapse-item title="v0.9.0 - 2023-07-07">
              <ol>
                <li>支持登录IP黑名单限制</li>
                <li>操作日志新增消耗时间属性</li>
